...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dillation=1):
    """
    ...
    :param dillation: dilation rate
    :return: 3x3 convolution
    """
    return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=dillation, groups=groups, bias=False, dilation=dillation)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        :param groups: use when model is ResNext
        :param base_width: use when model is Wide ResNet
